...
################################################################################
{
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            ...
            'pos_access_right_hr/static/src/js/SelectPartnerButton.js',
            'pos_access_right_hr/static/src/js/OrderTabs.js',
            'pos_access_right_hr/static/src/js/ControlButtons.js',
            'pos_access_right_hr/static/src/js/ProductScreen.js',
            'pos_access_right_hr/static/src/xml/ActionpadWidget.xml',
            'pos_access_right_hr/static/src/xml/SelectPartnerButton.xml',
            'pos_access_right_hr/static/src/xml/ControlButtons.xml',
            'pos_access_right_hr/static/src/xml/OrderTabs.xml',
        ],
    },
